        ...
        <div className="dropdown" style={{ paddingTop: "7px" }}>
          ...
          <ul className="dropdown-menu">
            ...
            <Link to="Check" style={{ textDecoration: "none" }}>
              <li><button className="dropdown-item" type="button"><a href="checkout.html" style={{ textDecoration: "none", color: "black" }}>Checkout</a></button></li>
            </Link>
            <Link to="Dropspot" style={{ textDecoration: "none" }}>
              <li><button className="dropdown-item" type="button"><a href="Drop.html" style={{ textDecoration: "none", color: "black" }}>Boarding</a></button></li>
            </Link>
