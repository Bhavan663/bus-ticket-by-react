...
function Ticket() {
    return (
        <div className="container-fluid" style={{ fontSize: "15px", color: "#3e3e52", fontFamily: "'Montserrat', sans-serif", marginTop: "100px" }}>
                ...
                <div className="container-fluid">
                    <div className="row justify-content-center" style={{ gap: "8px" }}>
                        <div className="col-lg-3">
                            <h1 className="text-center mb-4" style={{ fontSize: "20px", fontWeight: "600", color: "#3e3e52" }}>CANCEL YOUR TICKET</h1>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="container-fluid" style={{ fontFamily: "'Montserrat', sans-serif", marginTop: "70px" }}>
                <div className="d-flex justify-content-center align-items-center" style={{ minHeight: "1vh", marginLeft: "2px" }}>
                    <div className="container-fluid">
                        <div className="row justify-content-center" style={{ gap: "80px" }}>
                            <div className="col-lg-3">
                                <div className="mb-3">
                                    <label htmlFor="Ticket Number" className="form-label" style={{ fontWeight: "600", fontSize: "14px", letterSpacing: "0.3px", color: "#3e3e52" }}>TICKET
                                        NUMBER</label>
                            ...
                            <div className="col-lg-3">
                                <div className="mb-3">
                                    <label htmlFor="Ticket Number" className="form-label" style={{ fontWeight: "600", fontSize: "14px" }}>MOBILE
                                        NUMBER</label>
                                    <div className="d-flex gap-1" style={{ marginTop: "10px", borderBottom: "1px solid #dbdbdb", borderColor: "#d2d2d2" }}>
